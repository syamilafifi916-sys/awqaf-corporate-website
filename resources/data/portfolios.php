...
return [
    ...
    [
        ...
        'facts' => [],
        'history' => [],
        'status_note' => 'Nota: AHB Fintech membina infrastruktur digital yang menyokong kewangan sosial Islam dan tidak beroperasi sebagai bank digital. Keupayaan yang dinyatakan sebagai visi jangka panjang mencerminkan hala tuju strategik, bukan produk yang sedia tersedia.',
        'related_links' => [],
        'reports' => [2024],
        'display_order' => 4,
    ],
